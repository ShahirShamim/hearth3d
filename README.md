...
Hearth3D connects to your local Home Assistant instance, automatically discovers your **floors, areas, devices, and entities**, and renders them as a dark-mode isometric floor plan. Rooms become grid cards; lights, switches, media players, cameras, sensors and more appear on the room they belong to. States update live, clicking a device controls it, and everything about the view — positions, names, rooms, floors, visibility — is customizable.

![Hearth3D isometric dashboard](docs/screenshot.png)
